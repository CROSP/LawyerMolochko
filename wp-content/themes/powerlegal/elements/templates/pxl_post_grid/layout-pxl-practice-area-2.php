...
$post_type            = $widget->get_setting('post_type','pxl-practice-area');
$layout               = $widget->get_setting('layout_'.$post_type, 'pxl-practice-area-1');
...
$widget->add_render_attribute( 'wrapper', [
    'id'               => $html_id,
    'class'            => trim('pxl-grid pxl-practice-area-grid layout-'.$layout),

<?php
/**
* The Powerlegal_Admin initiate the theme admin
*/
...
class Powerlegal_Admin extends Powerlegal_Base{
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = powerlegal()->get_name().' '.esc_html__( 'Dashboard', 'powerlegal' );

...
<p>Email: {{user_email}}</p>',
		...
		'Практичний досвід' => 'Experiență practică',
		'Останні кейси' => 'Ultimele cazuri',
		'Наша відданість справі та досвід дозволяють ефективно представляти ваші інтереси — від консультації до суду. ТЦК, ВЛК, ДТП, кримінал, сімейні та трудові спори.' => 'Dedicarea și experiența noastră ne permit să vă reprezentăm eficient interesele — de la consultație până în instanță. TCC, VLC, accidente rutiere, penal, dispute familiale și de muncă.',
		'Усі кейси' => 'Toate cazurile',
		'Кейси' => 'Cazuri',
		'Наша відданість справі та досвід дозволяють ефективно представляти ваші інтереси — від консультації до суду.' => 'Dedicarea și experiența noastră ne permit să vă reprezentăm eficient interesele — de la consultație până în instanță.',
		'Кейси за цією категорією.' => 'Cazuri din această categorie.',
		// Law Talk section
		'Блог про право' => 'Blog despre drept',
		'Law Talk' => 'Law Talk',
		'Короткі відео про право українською: що варто знати про закони, ваші права та типові ситуації. Дивіться наші Reels в Instagram та відео в TikTok — просто та зрозуміло.' => 'Videoclipuri scurte despre drept: ce merită să știți despre legi, drepturile dumneavoastră și situațiile tipice. Uitați-vă la Reels pe Instagram și la videoclipuri pe TikTok — simplu și clar.',
		'Дивіться наші відео про право в Instagram та TikTok — підписуйтесь на канали вище.' => 'Vedeți videoclipurile noastre despre drept pe Instagram și TikTok — abonați-vă la canalele de mai sus.',
		'Instagram Law Talk' => 'Instagram Law Talk',
		'TikTok Law Talk' => 'TikTok Law Talk',
		'Дивитися відео' => 'Vizionează video',
		// Blog archive hero & listing
		'Блог' => 'Blog',
		'Про право та практику' => 'Despre drept și practică',
		'Корисні статті про законодавство, ваші права та типові юридичні ситуації.' => 'Articole utile despre legislație, drepturile dumneavoastră și situațiile juridice tipice.',
		'Статей поки немає.' => 'Nu există încă articole.',
		'На головну' => 'Acasă',
		'Навігація по сторінках' => 'Navigare pagini',
		'Назад' => 'Înapoi',
		'Далі' => 'Înainte',
		'Читати далі' => 'Citește mai mult',
		// Reviews section
		'Що кажуть клієнти' => 'Recenzii clienți',
		'Відгуки клієнтів' => 'Recenzii clienți',
		'Реальні історії та подяки від тих, хто звертався до нас за юридичною допомогою.' => 'Povești reale și mulțumiri de la cei care au apelat la noi pentru ajutor juridic.',
		'Переглянути кейси' => 'Vizualizează cazuri',
		// Reviews archive (slightly different desc in UA)
		'Реальні історії та відгуки людей, яким ми допомогли.' => 'Povești reale și mulțumiri de la cei care au apelat la noi pentru ajutor juridic.',
		'Що говорять клієнти' => 'Recenzii clienți',
		'Навігація по відгуках' => 'Navigare recenzii',
		'Відгуків поки немає.' => 'Nu există încă recenzii.',

...
<div id="consultation-popup" class="molochko-consultation-popup is-closed" role="dialog" aria-modal="true" aria-labelledby="consultation-popup-title" aria-hidden="true">
	...
	<div class="molochko-consultation-popup-dialog" tabindex="-1">
		<div class="molochko-consultation-popup-content">
			<button type="button" class="molochko-consultation-popup-close" data-close="consultation" aria-label="<?php echo molochko_pll_esc_attr__( 'Закрити' ); ?>">
				<i class="zmdi zmdi-close" aria-hidden="true"></i>
			</button>
			<h2 id="consultation-popup-title" class="molochko-consultation-popup-title"><?php molochko_pll_esc_html_e( 'Замовити консультацію' ); ?></h2>
			<p class="molochko-consultation-popup-desc"><?php molochko_pll_esc_html_e( 'Залиште заявку — ми передзвонимо або напишемо вам найближчим часом.' ); ?></p>
			<?php if ( $cf7_shortcode ) : ?>
				<div class="molochko-consultation-popup-form">
					<?php echo do_shortcode( $cf7_shortcode ); ?>
				</div>
			<?php else : ?>
				<p class="molochko-consultation-popup-missing"><?php molochko_pll_esc_html_e( 'Створіть форму в Контакт → Контактні форми (Contact Form 7).' ); ?></p>
			<?php endif; ?>
		</div>
	</div>
</div>
